...
from eventyay.common.mixins.views import (
    ActionFromUrl,
...
from eventyay.common.templatetags.rich_text import rich_text
from eventyay.common.views import OrderModelView, is_form_bound
...
from eventyay.event.models import Event, Team, TeamInvite
...
from eventyay.person.forms import LoginInfoForm, OrgaProfileForm, UserForm
from eventyay.person.models import User
from eventyay.submission.models import ReviewPhase, ReviewScoreCategory
