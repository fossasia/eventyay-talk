...
from eventyay.api.serializers.speaker import SubmitterOrgaSerializer, SubmitterSerializer
from eventyay.schedule.models import Schedule, TalkSlot
from eventyay.submission.models import Resource, Submission, SubmissionStates, Tag
