...
import eventyay.common.mixins.models
import eventyay.event.models.organiser
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(eventyay.common.mixins.models.LogMixin, models.Model),
        ),
        migrations.CreateModel(
            name="Team",
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default=eventyay.event.models.organiser.generate_invite_token,
                        max_length=64,
                        null=True,
                    ),
                ),
