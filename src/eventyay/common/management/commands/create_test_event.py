...
from eventyay.event.models import Event, Team
from eventyay.event.utils import create_organiser_with_team
from eventyay.person.models import SpeakerProfile, User
from eventyay.schedule.models import Room
from eventyay.submission.models import Review, Submission, SubmissionType, Track
