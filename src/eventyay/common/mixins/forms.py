...
from eventyay.common.forms.utils import (
...
from eventyay.submission.models.cfp import default_fields
...
class QuestionFieldsMixin:
    def get_field(self, *, question, initial, initial_object, readonly):
        from eventyay.submission.models import QuestionVariant
    ...
    def save_questions(self, k, v):
        ...
        from eventyay.submission.models import Answer, QuestionTarget
