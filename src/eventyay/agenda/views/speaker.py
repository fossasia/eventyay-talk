...
from eventyay.common.utils import safe_filename
from eventyay.person.models import SpeakerProfile, User
from eventyay.submission.models import QuestionTarget
...
class SpeakerTalksIcalView(PermissionRequired, DetailView):
    ...
    def get(self, request, event, *args, **kwargs):
        ...
        cal.add(
            "prodid"
        ).value = f"-//eventyay//{netloc}//{request.event.slug}//{speaker.code}"
